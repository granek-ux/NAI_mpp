...
public class Main {
    static String testFileName = "../iris_test.txt";
    static String trainingFileName = "../iris_training.txt";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            int compute = perceptron.Compute(sygnaly );

            String wynik = compute == 1 ? "Iris-setosa" : "To nie setosa";
